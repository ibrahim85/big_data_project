    ...
    if (color == "uber"):
        ...
        if (bucket != current_bucket):
            if current_bucket:
                ...
                print "%s^%s\t%d,%0.2f%d" % (current_color, current_bucket,
                    count, pickup_dist_subway, 0)
        ...
        if (bucket != current_bucket):
            if current_bucket:
                ...
                print "%s^%s\t%d,%0.2f,%0.2f,%0.2f,%0.2f,%0.2f,%0.2f" % (
                    current_color, current_bucket, count,
                    distance_traveled, fare_amount, total_amount,
...
if current_bucket:
    if (current_color == "uber"):
        ...
        print "%s^%s\t%d,%0.2f,%0.2f,%0.2f,%0.2f,%0.2f,%0.2f" % (current_color,
